...
pmleHSMM<-function(y,N,p_list,mu,sigma=NULL,omega=NULL,delta=NULL,lambda,order_diff,y_dist,stationary=TRUE,p_ref=2,print.level = 0,iterlim = 10000,stepmax = NULL,hessian=FALSE,gradtol=10^(-6)){
  # check parameters
